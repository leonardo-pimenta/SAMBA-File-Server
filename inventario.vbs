...
Set objFSO = CreateObject("Scripting.FileSystemObject")
    ...
    On Error Resume Next
    Set objFSO = CreateObject("Scripting.FileSystemObject")
    Set objtextfile = objFSO.deleteFile("\\cccpmfs\inventarioTI\" & STRcomputer & ".HTML")
    Set objtextfile = objFSO.CreateTextFile("\\cccpmfs\inventarioTI\" & STRcomputer & ".HTML", Forwritting)
