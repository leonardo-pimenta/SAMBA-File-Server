...
Set objFSO = CreateObject("Scripting.FileSystemObject")
    ...
    On Error Resume Next
    Set objFSO = CreateObject("Scripting.FileSystemObject")
    Set objtextfile = objFSO.deleteFile("\\cccpmfs\inventarioTI\ADRUSR\" & STRcomputer & "-" & STRusername & ".HTML")
    Set objtextfile = objFSO.CreateTextFile("\\cccpmfs\inventarioTI\ADRUSR\" & STRcomputer & "-" & STRusername & ".HTML", Forwritting)
    Objtextfile.writeline "<html>"
    Objtextfile.writeline "<!-----Inventario de Estações----->"
    Objtextfile.writeline "<!-----Bruno Conde----->"
    ...
    objtextfile.WriteLine "<!WKS" & STRusername & "Fim_WKS>"
    objtextfile.WriteLine "<center><H1><b>" & STRusername & "</b></h1></center>"
